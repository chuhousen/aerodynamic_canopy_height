...
Assume z0=coef1*ha; d=coef2*ha, where ha is the theoretical canopy height (aerodynamic canopy height, m), then, for any given coef1 & coef2, we can calculated ha from the equation:
